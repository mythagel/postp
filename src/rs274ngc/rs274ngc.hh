...
private:
	...
	static void read_a(const char * line, int * counter, block_t& block, double * parameters);
	static void read_atan(const char * line, int * counter, double * double_ptr, double * parameters);
	static void read_b(const char * line, int * counter, block_t& block, double * parameters);
	static void read_c(const char * line, int * counter, block_t& block, double * parameters);
	static void read_comment(const char * line, int * counter, block_t& block, double * parameters);
	static void read_d(const char * line, int * counter, block_t& block, double * parameters);
	static void read_f(const char * line, int * counter, block_t& block, double * parameters);
	static void read_g(const char * line, int * counter, block_t& block, double * parameters);
	static void read_h(const char * line, int * counter, block_t& block, double * parameters);
	static void read_i(const char * line, int * counter, block_t& block, double * parameters);
	static void read_integer_unsigned(const char * line, int * counter, unsigned int * integer_ptr);
	static void read_integer_value(const char * line, int * counter, int * integer_ptr, double * parameters);
	void read_items(block_t& block, const char * line, double * parameters) const;
	static void read_j(const char * line, int * counter, block_t& block, double * parameters);
	static void read_k(const char * line, int * counter, block_t& block, double * parameters);
	static void read_l(const char * line, int * counter, block_t& block, double * parameters);
	static void read_line_number(const char * line, int * counter, block_t& block);
	static void read_m(const char * line, int * counter, block_t& block, double * parameters);
	void read_one_item(const char * line, int * counter, block_t& block, double * parameters) const;
	static void read_operation(const char * line, int * counter, BinaryOperation * operation);
	static void read_operation_unary(const char * line, int * counter, UnaryOperation * operation);
	static void read_p(const char * line, int * counter, block_t& block, double * parameters);
	void read_parameter(const char * line, int * counter, double * double_ptr, double * parameters) const;
	static void read_parameter_setting(const char * line, int * counter, block_t& block, double * parameters);
	static void read_q(const char * line, int * counter, block_t& block, double * parameters);
	static void read_r(const char * line, int * counter, block_t& block, double * parameters);
	static void read_real_expression(const char * line, int * counter, double * hold2, double * parameters);
	static void read_real_number(const char * line, int * counter, double * double_ptr);
	static void read_real_value(const char * line, int * counter, double * double_ptr, double * parameters);
	static void read_s(const char * line, int * counter, block_t& block, double * parameters);
	static void read_t(const char * line, int * counter, block_t& block, double * parameters);
	static int read_text(const char * command, char * raw_line, char * line, unsigned int * length);
	static void read_unary(const char * line, int * counter, double * double_ptr, double * parameters);
	static void read_x(const char * line, int * counter, block_t& block, double * parameters);
	static void read_y(const char * line, int * counter, block_t& block, double * parameters);
	static void read_z(const char * line, int * counter, block_t& block, double * parameters);
